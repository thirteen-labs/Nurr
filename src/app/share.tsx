  ...
  async function shareBlueprintCard() {
    ...
    try {
        ...
        <html>
          ...
          <body>
            <div class="header">
              ...
              <div class="subtitle">Cosmic Oracle Blueprint</div>
            </div>
            <div class="signs">
              <div class="sign-item">
            ...
            <div class="footer">${PHASE_EMOJIS[shareData.moonPhase]} ${shareData.moonData.title} • Generated by Cosmic Oracle</div>
          </body>
        </html>
      `;
      ...
      if (Platform.OS === 'web') {
        ...
        link.download = `CosmicOracle_${shareData.name}_Card.pdf`;
        link.click();
        Alert.alert('Saved', 'Card downloaded successfully!');
      } else {
        const pdfName = `CosmicOracle_${shareData.name}_Card.pdf`;
          ...
          <>
            ...
            {shareData && (
              <View style={[styles.previewCard, { backgroundColor: '#1a1a2e', borderColor: theme.cardBorder }]}>
                ...
                <Text style={styles.previewSubtitle}>Cosmic Oracle Blueprint</Text>
